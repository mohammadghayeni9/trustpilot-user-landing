...
<template>
	<footer
		class="footer_footer__zQOqV footer_responsive__AB6S9"
		role="contentinfo"
	>
		<div
			data-constellation-section-theme="black"
			class="footer_footerTheme__O29kH section-theme-provider_theme-black__PddZ0"
		>
			<div class="footer_footerWrapper__CsRW1">
				<div class="footer_logoContainer__4J__O">
					<img
						class="footer_logo__1vidz"
						alt="Trustpilot reviews"
						src="https://cdn.trustpilot.net/brand-assets/4.3.0/logo-white.svg"
					/>
				</div>
				<div class="flex flex-wrap justify-between w-full">
          <section class="footer_section__PMjdX">
					<h3
						class="typography_heading-xs__0E0Pg typography_appearance-subtle__pN7oO"
					>
						About
					</h3>
					<ul class="footer_links___ksgT">
						<li>
							<router-link
								to="#"
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
						...
						<li>
							<router-link
								...
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
								>How Trustpilot works</router-link
							>
						</li>
						<li>
							<router-link
								...
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
								>Transparency Report</router-link
							>
						</li>
						<li>
							<router-link
					...
					<ul class="footer_links___ksgT">
						<li>
							<router-link
								...
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
								>Trustpilot Business</router-link
							>
						</li>
						<li>
							<router-link
				...
				<section class="footer_section__PMjdX">
					...
					<ul
						class="footer_links___ksgT footer_links--horizontal-phone__i82jj"
					>
						<li
							class="social-media-icon-link_socialMediaIconLink__5qWh9"
						>
							<router-link
								to="#"
								rel="noopener"
								...
								target="_blank"
								aria-label="Facebook"
								class="link_internal__uk9WZ link_wrapper__cESXa social-media-icon-link_link__A9rDh"
								title="Facebook"
								data-facebook-icon-link="true"
								><svg
									viewBox="0 0 16 16"
									fill="inherit"
								...
								>
									<path
										d="m11.469 8-.355 2.313H9.25v5.59a8 8 0 1 0-2.5 0v-5.59H4.719V8H6.75V6.237c0-2.005 1.194-3.112 3.022-3.112a12.034 12.034 0 0 1 1.79.156V5.25h-1.008a2.18 2.18 0 0 0-.179.007c-.853.07-1.125.65-1.125 1.242V8h2.219Z"
									/></svg
							></router-link>
						</li>
						<li
						...
						>
							<router-link
								...
								>
									<path
										d="M12.599 1h2.43L9.682 7.143 16 15.438h-4.928l-3.888-5.032-4.407 5.032H.312L6.04 8.913 0 1h5.067l3.471 4.616L12.598 1Zm-.868 12.98h1.354L4.338 2.388H2.881l8.85 11.592Z"
									/></svg
							></router-link>
						</li>
						<li
				...
				<div class="footer_legal__oXovF">
					<ul
						class="footer_links___ksgT footer_linksHorizontalWhenPossible__1mS_S flex flex-wrap justify-center"
					>
						<li>
							<router-link
								to="#"
						...
						<li>
							<router-link
								...
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
								>Guidelines for Reviewers</router-link
							>
						</li>
						<li>
							<router-link
						...
						<li>
							<router-link
								...
								target="_self"
								class="link_internal__uk9WZ typography_body-m__M8pz1 typography_appearance-default__ISosD link_link__Wnd07 link_notUnderlined__A4AJs footer-link_footerLink__wB8O2"
								>Modern Slavery Statement</router-link
							>
						</li>
					</ul>
					<div
						class="typography_body-m__M8pz1 typography_appearance-subtle__pN7oO footer_copyrightNotice__Ylq6_ text-center"
					>
						© 2025 Trustpilot, Inc. All rights reserved
					</div>
				</div>
			</div>
		</div>
